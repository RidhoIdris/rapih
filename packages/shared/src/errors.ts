...
export const ERROR_MESSAGES = {
  ...
  'receipt.already_consumed': 'Struk sudah disimpan.',
  'receipt.invalid_state': 'Struk tidak dalam status yang valid untuk aksi ini.',
  'receipt.not_found': 'Struk tidak ditemukan.',
  'receipt.scan_not_found': 'Struk tidak ditemukan.',
  'receipt.size_exceeded': 'Ukuran gambar melebihi batas.',
  'receipt.upload_missing': 'Upload struk belum selesai.',
  'recurring.not_found': 'Tagihan rutin tidak ditemukan.',
  'tanya.job_not_found': 'Sesi streaming tidak ditemukan.',
  'tanya.session_not_found': 'Sesi Tanya tidak ditemukan.',
  'tier.upgrade_required': 'Fitur ini butuh Rapih Plus.',
