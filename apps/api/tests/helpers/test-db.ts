...
export async function resetTestDb(): Promise<void> {
  ...
  await prisma.$executeRawUnsafe(
    'TRUNCATE TABLE "refresh_tokens", "social_accounts", "user_profiles", "device_tokens", "transactions", "recurring_transactions", "goals", "budget_categories", "budgets", "receipts", "wallets", "categories", "users" RESTART IDENTITY CASCADE'
  );
